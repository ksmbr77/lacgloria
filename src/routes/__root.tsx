...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LacGlória" },
      { name: "description", content: "Distribuição de queijos para mercados e mercadinhos" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "LacGlória" },
      { property: "og:description", content: "Distribuição de queijos para mercados e mercadinhos" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "LacGlória" },
      { name: "twitter:description", content: "Distribuição de queijos para mercados e mercadinhos" },
